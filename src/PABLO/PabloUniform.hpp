 ...
 * 
 * \brief PABLO Uniform is an example of user class derived from ParaTree to 
 *        map ParaTree in a uniform (square/cubic) domain.
 *
 * Pablo Uniform takes as input in constructor the coordinates of
 * the origin (X,Y,Z) and the length of the side L.
 *
