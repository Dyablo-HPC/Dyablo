 ...
 *
 */
class CopyFaceBlockCellDataHashFunctor3d
{
...
public:
   ...
   *
   */
  CopyFaceBlockCellDataHashFunctor3d(AMRMetaData<dim> mesh,
                                     HydroParams params,
                                     id2index_t fm,
                    ...
                    FlagArrayBlock Interface_flags)
  {
    ...
    CopyFaceBlockCellDataHashFunctor3d functor(mesh, params, fm, 
    ...
    Kokkos::parallel_for("dyablo::muscl_block::CopyFaceBlockCellDataHashFunctor3d",
                         policy, functor);
  }
...
}; // CopyFaceBlockCellDataHashFunctor3d
