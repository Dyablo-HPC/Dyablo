/**
 * \file ConvertToPrimitivesGlobalHydroFunctor.h
 * \author Pierre Kestener
 */
#ifndef CONVERT_TO_PRIMITIVES_GLOBAL_HYDRO_MUSCL_BLOCK_FUNCTOR_H_
#define CONVERT_TO_PRIMITIVES_GLOBAL_HYDRO_MUSCL_BLOCK_FUNCTOR_H_
 ...
 *
 */
class ConvertToPrimitivesGlobalHydroFunctor {
...
public:
   ...
   */
  ConvertToPrimitivesGlobalHydroFunctor(std::shared_ptr<AMRmesh> pmesh,
                                        HydroParams    params,
                                        id2index_t     fm,
                    ...
                    DataArrayBlock Qdata)
  {
    ...
    ConvertToPrimitivesGlobalHydroFunctor functor(pmesh, params, fm, 
                                                  blockSizes,
                                                  Udata, Qdata);
    ...
    Kokkos::parallel_for("dyablo::muscl_block::ConvertToPrimitivesGlobalHydroFunctor",
                         policy, functor);
  }
...
}; // ConvertToPrimitivesGlobalHydroFunctor

} // namespace muscl_block

} // namespace dyablo

#endif // CONVERT_TO_PRIMITIVES_GLOBAL_HYDRO_MUSCL_BLOCK_FUNCTOR_H_
