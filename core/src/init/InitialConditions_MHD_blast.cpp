...
struct AnalyticalFormula_MHD_blast : public AnalyticalFormula_base{
    ...
    AnalyticalFormula_MHD_blast( ConfigMap& configMap ) :
        ...
        blast_B ( configMap.getValue<real_t>("blast", "blast_B", 3.54490770) ),
        blast_B_angle ( configMap.getValue<real_t>("blast", "blast_alpha", 0.7853981633974483) ),
    ...
    {
        return false ;
        //AnalyticalFormula_tools::auto_refine( *this, gamma0, smallr, smallp, error_max,
        //                                              x, y, z, dx, dy, dz );
    }
