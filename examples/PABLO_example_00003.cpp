...
/*!
  ...
  This example shows how to use PABLO's methods to find neighboring quadrants
  ...
  In this example neighbor-search is used to perform a simple 
  moving-average-smoothing procedure of the data.
  
  The obtained results show the time-evolution of data over 25 smoothing 
  iterations.
